	...
	I will be right back!
			...
			<form action="orderedit.php?id=<?php echo $eid ?>" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="desc" style="width:200px; height: 40px;"
						value="<?php echo ($old['description']) ?>" /><br /><br />
				</div>
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<?php echo ($currency); ?> <input type="text" name="amount" style="width:200px; height: 40px;"
							value="<?php echo ($old['amount']) ?>" /><br /><br />
					</div>

					<div class="form-group">

						<label>Paid</label><br />
						<?php echo ($currency); ?> <input type="text" name="paid" style="width:200px; height: 40px;"
							value="<?php echo ($old['paid']) ?>" /><br /><br />
					</div>
					...
					<div class="form-group">
						...
						<input type="date" name="date_received" style="width:200px; height: 40px;"
							value="<?php echo ($old['date_received']) ?>" /><br /><br />
					</div>
					...
					<div class="form-group">
						...
						<input type="date" name="date_collected" style="width:200px; height: 40px;"
							value="<?php echo ($old['date_collected']) ?>" /><br /><br />
					</div>
